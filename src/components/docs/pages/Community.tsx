const faq = [
  ...
  ['What frameworks are supported?', 'React (via the Fiber tree). Component names, file paths, props, hooks, and context are captured in dev mode.'],
  ['How many elements can I select?', 'As many elements as you want to pass as context'],
